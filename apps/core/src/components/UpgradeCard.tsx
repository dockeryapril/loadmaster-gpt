...
export function UpgradeCard({ className, onUpgrade }: UpgradeCardProps) {
  return (
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid gap-3">
          ...
          <div className="flex items-center gap-2 p-3 bg-background/50 rounded-lg border">
            ...
            <div className="text-xs">
              ...
              <p className="text-muted-foreground">vs 4 on free plan</p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-2 space-y-2">
          ...
          <p className="text-xs text-center text-muted-foreground">
            You have 4 image uploads on the free plan.
          </p>
        </div>
      </CardContent>
    </Card>
