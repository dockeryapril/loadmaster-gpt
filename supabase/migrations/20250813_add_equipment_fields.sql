...
-- Non-destructive migration to add equipment-aware fields and hotshot surcharge prefs.

-- USER SETTINGS: store equipment and optional custom RPM thresholds
ALTER TABLE IF EXISTS public.user_settings
  ADD COLUMN IF NOT EXISTS equipment TEXT NOT NULL DEFAULT 'cargo_van' CHECK (equipment IN ('cargo_van','straight_truck','hotshot')),
  ADD COLUMN IF NOT EXISTS rpm_thresholds_json JSONB;

-- NEGOTIATION SETTINGS: add standard hotshot surcharge fields
